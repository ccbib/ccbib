...
%\title{Content}
%\subject{Selected Essays on Technology, Creativity, Copyright and the Future of the Future}
%\author{By Cory Doctorow, doctorow@craphound.com}
%\date{}
%\maketitle
...
\section{Publication history and acknowledgments:}
\begin{parlist}
...
\section{Introduction by John Perry Barlow}
...
What a weird idea: that we should evaluate our record-pur\-chases on
...
\discretionary{does}{not}{doesn't}
