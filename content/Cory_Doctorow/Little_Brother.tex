...
\newcommand\edialog[1]{\textgreater \texttt{#1}}
...
this file (\url{http://craphound.com/littlebrother/download}) if there's an
...
$\bullet$ Audiobook from Random House:
...
MP3 file direct from RandomHouse or many other fine etailers, or
through this widget:
\url{http://www.zipidee.com/zipidAudioPreview.aspx?aid=c5a8e946-fd2c-4b9e-a748-f297bba17de8}

$\bullet$ My foreign rights agent, Danny Baror, has presold a number of
foreign editions:
\begin{itemize}
\item Greece: Pataki
...
\chapter{DONATIONS AND A WORD TO TEACHERS AND LIBRARIANS}
...
\url{http://craphound.com/littlebrother/category/donate/} by my fantastic
...
\chapter{ABOUT THE BOOKSTORE DEDICATIONS}
...
--and me!)}
{BakkaPhoenix Books: \url{http://www.bakkaphoenixbooks.com/} 697 Queen
...
wasn't enough -- the SchoolBook ran Windows Vista4Schools, an antique
...
posted a reader-review for my first novel! -- and I shop there like
...
{Secret Headquarters: \url{http://www.thesecretheadquarters.com/} 3817
W. Sunset Boulevard, Los Angeles, CA 90026 +1 323 666 2228}
...
\emph{other} route, through the Mission, which is... \emph{raucous} is probably
...
Once the food was ordered, the questions started again. They'd heard
...
leader. Van's the smart one. Darryl was... He was your
...
``Oh man, I am such an idiot. Jolu, you're the best-qualified person I
...
favorite Brazilian tecno-brega bands, Carioca Proibidão -- the
...
flash the firmware on a ten-dollar Radio Shack reader/writer and
...
see his armpit- and belly- and shoulder-hair escaping from. I peeled
...
magnified by her mannish, black-rimmed glasses. I couldn't tell what
...
It was written on the black-board when I got to Ms Galvez's Social
...
shouldn't be allowed to do illegal things.
...
of...car batteries. I laughed. Genius! That was how they were going to
...
that's an insult to hardworking whores everywhere. They're, they're
\emph{profiteers.}''
...
That was all the thought I gave the matter than night, until I got
...
\epigraph{This chapter is dedicated to the incomparable Mysterious
  ...
  \url{http://mysteriousgalaxy.booksense.com/NASApp/store/Product?s=showproduct&isbn=9780765319852}
  7051 Clairemont Mesa Blvd., Suite \fancybreak{\#}302 San Diego, CA
...
OVERTHROWING THE STATE. Here's one, DID THE SEPTEMBER 11TH BOMBINGS
...
amazing. I'd never been with a girl as...aggressive as her before. It
...
past. \emph{On the Road} is a semi-autobiographical novel about Jack
...
We walked a few steps. ``You weren't, you know, boyfriend/girlfriend
friends?''
...
against the Department of Homeland Security's anti-terrorism measures,
...
``Hold a press-conference,'' is what Ange said, as we sat in the cafe
...
But I wasn't scared then. The impending press-conference, the fights
...
The whole bus ride home, I thought over the press-conference, thought
...
As I fell asleep, the press-conference came back. I was really proud
...
I'd blown it, somehow. The press had come to my press-conference and
...
The DHS had their own press-conference announcing that they would
...
wifinder, change, batteries, retractable cables... I dumped it all out
...
{Booksmith \url{http://thebooksmith.booksense.com} 1644 Haight St. San
...
back on is. Each time we swung around a corner, I saw the valleys of
...
That's where I knew the name from. The free weekly \emph{Guardian} often
...
\texttt{250 mail.pirateparty.org.se Hello mail.pirateparty.org.se,
  pleased to meet you}

\edialog{MAIL FROM:m1k3y@littlebrother.com.se}

\texttt{250 2.1.0 m1k3y@littlebrother.com.se... Sender ok}

\edialog{RCPT TO:m1k3y@littlebrother.com.se}

\texttt{250 2.1.5 m1k3y@littlebrother.com.se... Recipient ok}

\edialog{DATA}

\texttt{354 Enter mail, end with ``.'' on a line by itself}

\edialog{When in trouble or in doubt, run in circles, scream and shout}

\edialog{.}

\texttt{250 2.0.0 k5SMW0xQ006174 Message accepted for delivery}

\edialog{QUIT}

\texttt{221 2.0.0 mail.pirateparty.org.se closing connection}

\texttt{Connection closed by foreign host.}
...
could send an IM to the server that said ``HELO littlebrother.com.se''
and it would reply with ``250 mail.pirateparty.org.se Hello
mail.pirateparty.org.se, pleased to meet you.'' In other words, you
...
computer's name -- like pirateparty.org.se -- to the IP number that
computers actually use to talk to each other over the net, like
204.11.50.136. It generally works like magic, even though it's got
...
just said VAMPMOB CIVIC CENTER -\textgreater -\textgreater that I we would spray-paint at
...
\epigraph{This chapter is dedicated to the MIT Press Bookshop, a store
  ...
  in my suitcase.}  {MIT Press Bookstore
...
are bail-bondsmen and liquor stores, places that cater to the families
...
my ID over to her. If she was on the other side...
...
I wanted to sit down on the sidewalk and bawl, but that wouldn't solve
...
civilians shortly after the bombing...''
...
requests, the fan mail, the hate mail, the spam...
...
press-conference held jointly on the steps of the Governor's mansion,
...
Go onto the net and look up Òbump keyÓ or ÒBic pen Kryptonite lockÓ;
...
mailing list at schneier.com/blog. Crypto and security are the realm
...
The guru of ``citizen journalism'' is Dan Gillmor, who is presently
...
at the dangers of a world of arphids.
...
Mendelsohn: The Boy From Mars'' (presently in print as part of the
...
Kevin Pouslen, Wendy Grossman, Jay Lake, Ben Rosenbaum
...
\LaTeX{} by Mikael Vejdemo Johansson.
