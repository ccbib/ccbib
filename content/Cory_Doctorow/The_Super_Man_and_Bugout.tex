...
``Mama, I'm \emph{not} a super-villain,'' Hershie said for the
...
ticks next to \textuppercase{INTRODUCTION, BACKGROUND, STRATEGY, THE DAY, SUPPORT
...
``Supe, let's you and me grab a coffee, huh?'' Thomas said, without
...
For his part, Thomas refused to acknowledge the risk; he\erratum{'d}{} was more
...
amalgamated into the new ``superportfolios\erratum{:''}{'':} Domestic Affairs,
...
``Thanks for seeing me,'' Hershie said. He caught his reflection in
...
``\emph{A week or two}?'' Hershie bellowed.
...
``Supe, we \emph{have} to talk about this. I mean, DefenseFest is only a week 
...
``So your purpose is speaking to military shows? Telling the world that it 
...
The chanting got louder as they neared the security cordon around
...
The cops were suddenly alert, moving, but Thomas was careful to
