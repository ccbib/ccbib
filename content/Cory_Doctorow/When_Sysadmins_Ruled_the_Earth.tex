...
\edialog{
Someone knocked over the Gherkin. Bankers are
...
\edialog{
Felix typed: I’m in Toronto. We just saw the CN Tower fall. I’ve
...
\edialog{
Looks like an EMP took out Hong Kong and maybe
...
\edialog{
Yes\dash{}on Front Street
}
\edialog{
my sisters at UofT and i cnt reach her\dash{}can you call
her?
}
\edialog{
No phone service
...
\edialog{
Christ I thought I was the last one alive. I’m on
...
\edialog{
Still here\dash{}sorting out some logistics
}
\edialog{
...
\edialog{
We can use the newsgroup voting mechanism to hold
regional
}
\edialog{
elections
...
\edialog{
We’ll elect regional representatives and they’ll
...
\edialog{
I think we should hold elections as soon as
...
\edialog{
You can’t be serious. Consent of the governed?
...
\edialog{
I don’t much care if I win, to be honest. I”m just
...
\edialog{
No of course not. I believe the Popovich Hypothesis.
...
\edialog{
You’re lucky your boss can’t see you type that. You
...
\edialog{
Yeah. Yeah. Anyway, I’m not worried about the
...
\edialog{
They won’t. They’re just tired and sad is all. Your
...
\edialog{
Uh, hi. I’m just a lightweight MSCE but I’m the only
...
\edialog{
sario i thought you wanted the network dead why are
you helping msces fix their boxen?
}
\edialog{
\textless{}sheepish grinGee Mr PM,
...
\edialog{
Since I slept? Two days. Until we run out of fuel?
Three days. Since we ran out of food? Two days.
}
\edialog{
Jeez. I didn’t sleep last night either. We’re a
little short handed around here.
}
\edialog{
asl? Im monica and I live in pasadena and Im bored
...
\edialog{
How come the spam isn’t reducing? Half the goddamned
data-centers have gone dark
}
\edialog{
Queen Kong paused a long time before typing. As had become
...
\edialog{
Spam’s still up because the services that stop spam
...
\edialog{
at the rate were going well be routing nothing but
spam by dinnertime
}
...
\edialog{
yeah well thats right then. it was an honor, mr
prime minister
}
\edialog{
you going to be ok?
...
\edialog{
ive commandeered a young sysadmin to see to my
...
\edialog{
youre amazing, Queen Kong, seriously. Dont be a hero
though. When you need to go go. Theres got to be something out
there
}
\edialog{
be safe felix, seriously\dash{}btw did i tell you queries
...
\edialog{
yeah, really. we’re hard to kill\dash{}like fucking
roaches
}
...
\edialog{
soon, kong, soon\dash{}almost got this backup running
}
\edialog{
youre a junkie, dude.
}
