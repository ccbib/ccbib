...
\newcommand\typing\texttt

\begin{document}
\begin{center}
\textbf{\huge\textsf{{When Sysadmins Ruled the Earth}}}
\end{center}
...
\section{Introduction to When Sysadmins Ruled the Earth}

I’ve changed careers every two or three years ever since I dropped
out of university in 1990, and one of the best gigs I ever had was
working as a freelance systems administrator, working in the steam
tunnels of the information age, pulling cables, configuring
machines, keeping the backups running, kicking the network in its
soft and vulnerable places. Sysadmins are the unsung heroes of the
century, and if they’re not busting you for sending racy IMs, or
engaging in unprofessional email conduct it’s purely out of their
own goodwill.

There’s a pernicious myth that the Internet was designed to
...
“I don’t like asking my reports to do anything I wouldn’t do,” he
said.
...
“Stay there, Kelly,” he shouted as the line died. He punched 911,
...
\edialog{pentagons gone/white house too}
\edialog{MY NEIGHBORS BARFING BLOOD OFF HIS BALCONY IN SAN
DIEGO}
\edialog{Someone knocked over the Gherkin. Bankers are
fleeing the City like rats.}
\edialog{I heard that the Ginza’s on fire}

Felix typed: \typing{I’m in Toronto. We just saw the CN Tower fall. I’ve
heard reports of bioweapons, something very fast.}

Van read this and said, “You don’t know how fast it is, Felix.
Maybe we were all exposed three days ago.”

Felix closed his eyes. “If that were so we’d be feeling some
symptoms, I think.”

\edialog{Looks like an EMP took out Hong Kong and maybe
Paris\dash{}realtime sat footage shows them completely dark, and all
netblocks there aren’t routing}
\edialog{You’re in Toronto?}

It was an unfamiliar handle.

\edialog{Yes\dash{}on Front Street}
\edialog{my sisters at UofT and i cnt reach her\dash{}can you call
her?}
\edialog{No phone service}
...
\edialog{Stop probing my server}
He expected bluster, guilt, denial. He was surprised.

\edialog{Are you in the Front Street data-center?}
\edialog{Yes}
\edialog{Christ I thought I was the last one alive. I’m on
the fourth floor. I think there’s a bioweapon attack outside. I
don’t want to leave the clean room.}
\edialog{Felix whooshed out a breath.}
\edialog{You were probing me to get me to trace back to you?}
\edialog{Yeah}
\edialog{That was smart}
Clever bastard.

\edialog{I’m on the sixth floor, I’ve got one more with me.}
\edialog{What do you know?}
...
\edialog{Are you there?}
\edialog{Still here\dash{}sorting out some logistics}
\edialog{How long until we can go out?}
\edialog{I have no idea}
...
\edialog{We can use the newsgroup voting mechanism to hold
regional elections}
...
\edialog{We’ll elect regional representatives and they’ll
...
\edialog{I think we should hold elections as soon as
possible. Tomorrow at the latest. We can’t rule justly without the
consent of the governed.}
Within seconds the reply landed in his inbox.

\edialog{You can’t be serious. Consent of the governed?
Unless I miss my guess, most of the people you’re proposing to
govern are puking their guts out, hiding under their desks, or
wandering shell-shocked through the city streets. When do THEY get
a vote?}
...
\edialog{Are you nervous?}
\edialog{Nope,}
Felix typed.

\edialog{I don’t much care if I win, to be honest. I\erratum{”}{'}m just
glad we’re doing this. The alternative was sitting around with our
thumbs up our ass, waiting for someone to crack up and open the
door.}
...
\edialog{China’s still running about ninety percent nominal.}
Felix shook his head.

\edialog{You can’t think that they’re responsible}
\edialog{No}
She typed, but then she started to key something and then stopped.

\edialog{No of course not. I believe the Popovich Hypothesis.
This is a bunch of assholes all using the rest for cover. But China
put them down harder and faster than anyone else. Maybe we’ve
finally found a use for totalitarian states.}
\edialog{Felix couldn’t resist. He typed:}
\edialog{You’re lucky your boss can’t see you type that. You
guys were pretty enthusiastic participants in the Great Firewall of
China.}
\edialog{Wasn’t my idea}
she typed.

\edialog{And my boss is
dead. They’re probably all dead. The whole Bay Area got hit hard,
...
\edialog{Sorry. I forgot.}
\edialog{It’s OK. We all lost people, right?}
\edialog{Yeah. Yeah. Anyway, I’m not worried about the
election. Whoever wins, at least we’re doing SOMETHING}
\edialog{Not if they vote for one of the fuckrags}
...
\edialog{They won’t. They’re just tired and sad is all. Your
endorsement will carry the day}
The Googloids were one of the largest and most powerful bloc\erratum{}{k}s left
...
\edialog{half my crew split this morning}
...
\edialog{we’re down to a quarter}
...
\edialog{Runaway processes on Solaris}
\edialog{\textgreater{}}
\edialog{Uh, hi. I’m just a lightweight MSCE but I’m the only
one awake here and four of the DSLAMs just went down. Looks like
there’s some custom accounting code that’s trying to figure out how
much to bill our corporate customers and it’s spawned ten thousand
threads and its eating all the swap. I just want to kill it but I
can’t seem to do that. Is there some magic invocation I need to do
to get this goddamned weenix box to kill this shit? I mean, it’s
not as if any of our customers are ever going to pay us again. I’d
ask the guy who wrote this code, but he’s pretty much dead as far
as anyone can work out.}
He reloaded. There was a response. It was short, authoritative, and
helpful\dash{}just the sort of thing you almost never saw in a
high-caliber newsgroup when a noob posted a dumb question. The
apocalypse had awoken the spirit of patient helpfulness in the
world’s sysop community.
...
\edialog{sario i thought you wanted the network dead why are
you helping msces fix their boxen?}
\edialog{\textless{}sheepish grinGee Mr PM,
maybe I just can’t bear to watch a computer suffer at the hands of
an amateur.}
\edialog{He flipped to the channel with Queen Kong in it.}
\edialog{How long?}
\edialog{Since I slept? Two days. Until we run out of fuel?
Three days. Since we ran out of food? Two days.}
\edialog{Jeez. I didn’t sleep last night either. We’re a
little short handed around here.}
\edialog{asl? Im monica and I live in pasadena and Im bored
with my homework. WOuld you like to download my pic???}
The trojan bots were all over IRC these days, jumping to every
channel that had any traffic on it. Sometimes you caught five or
six flirting with each other. It was pretty weird to watch a piece
of malware try to con another instance of itself into downloading a
trojan.

They both kicked the bot off the channel simultaneously. He had a
script for it now. The spam hadn’t even tailed off a little.

\edialog{How come the spam isn’t reducing? Half the goddamned
data-centers have gone dark}
\edialog{Queen Kong paused a long time before typing. As had become
automatic when she went high-latency, he reloaded the Google
homepage. Sure enough, it was down.}
\edialog{Sario, you got any food?}
\edialog{You won’t miss a couple more meals, Your Excellency}
Van had gone back to Mayor McCheese but he was in the same
channel.
...
\edialog{hey kong everything ok?}
\edialog{everything’s fine just had to go kick some ass}
...
\edialog{Spam’s still up because the services that stop spam
are failing faster than the services that create it. All the
anti-worm stuff is centralized in a couple places. The bad stuff is
on a million zombie computers. If only the lusers had had the good
sense to turn off their home PCs before keeling over or taking off}
\edialog{at the rate were going well be routing nothing but
spam by dinnertime}
...
He scrubbed away a clean spot with his sleeve and began to write
...
\edialog{Were going, kong. Fuels almost out anyway}
\edialog{yeah well thats right then. it was an honor, mr
prime minister}
\edialog{you going to be ok?}
\edialog{ive commandeered a young sysadmin to see to my
feminine needs and weve found another cache of food thatll last us
a coupel weeks now that were down to fifteen admins\dash{}im in hog
heaven pal}
\edialog{youre amazing, Queen Kong, seriously. Dont be a hero
though. When you need to go go. Theres got to be something out
there}
\edialog{be safe felix, seriously\dash{}btw did i tell you queries
are up in Romania? maybe theyre getting back on their feet}
\edialog{really?}
\edialog{yeah, really. we’re hard to kill\dash{}like fucking
roaches}
...
\edialog{go to bed, felix}
\edialog{soon, kong, soon\dash{}almost got this backup running}
\edialog{youre a junkie, dude.}
\edialog{look whos talking}
