...
„Aber warum soll diese Kluft unüberbrückbar sein?“
...
Jahrhunderts, in seinem Roman erklären müsste, was ein \wort{Rock}, eine
\wort{Wohnung}, eine \wort{Gattin} ist. Übrigens, wenn
sein Buch für unzivilisierte Völker übersetzt wurde, dann konnte
man kaum ohne eine Anmerkung zu dem Wort \wort{Rock} auskommen.

Wenn der Wilde \wort{Rock} las, dachte er gewiss: „Wozu das? Das ist doch
...
Augen. Unwillkürlich muss ich an das denken, was die Alten \wort{Ikone}
...
den \werk{Eisenbahnfahrplan}. Vergleichen Sie ihn einmal mit der
...
des \werk{Fahrplans} entlangjagen. Die Stunden-Gesetzestafel hingegen
...
des Problems \wort{Glück} haben selbst wir noch nicht gefunden: Zweimal am
...
sonderbare \erratum{I-300}{I-330} in seiner Gegenwart\ldots{} Ich muss gestehen, diese
...
wohl nicht zufällig eine gewisse Vorliebe für das Wort \wort{klar}). Heute
...
hatte entdeckt, dass, sooft das Barometer auf \wort{Regen} stand, es
tatsächlich regnete. Da der Wilde Regen haben wollte, kratzte er so
viel Quecksilber heraus, bis das Barometer auf \wort{Regen} stehen blieb.“
...
“\ldots{} Man dreht einfach an diesem Knopf und kann bis
...
\wort{Flügel}, was wiederum beweist, wie sehr ihre ganze Musik \ldots{}“
...
Um \erratum{22}{21} Uhr ließ ich die Vorhänge herunter, und da trat O auch schon
...
nur aus religiösen Vorurteilen hartnäckig an ihrem \wort{Brot} fest.
...
unsere \werk{Lex sexualis} in Kraft. Jede Nummer hat ein Recht auf eine
...
Bruches \wort{Zufriedenheit} ist Null geworden — und der Bruch wird zur
...
\uebersicht{\emph{Übersicht:} Ein Zufall. Das verfluchte \wort{klar}. 24
Stunden.}
...
unsere Vorfahren \wort{Wohnung}). Ein seltsames Musikinstrument stand
dort, ein \wort{Flügel}, und in dem ganzen Zimmer war der gleiche
...
blitzten: „Sie ist die hässlichste aller \markup{Wohnungen} von einst.“
...
ungeheurer \markup{Kamin}, ein großes Mahagonibett. Unser schönes
...
scheußlichen \markup{Wohnungen}; sein Kopf ist undurchsichtig, nur zwei
...
drinnen ein Feuer brannte, irgendein \markup{Kamin}, und da waren Gestalten,
ähnlich wie\ldots{}
...
„Ach“, sagte I, „gehen Sie doch bitte für eine Minute
ins Nebenzimmer.“
...
\wort{banal} sein bedeutete, das heißt bei uns: seine Pflicht erfüllen.
Denn\ldots{}“
...
„Klar\ldots{} das heißt, ich wollte\ldots{}“ (O dieses verfluchte \wort{klar}!)
...
\erratum{Sanft}{Saft}, Buddha\ldots{} was für ein Unsinn! Mir ist klar, dass ich krank
...
gut. Aber können Sie von dem Geruch selbst, von dem Begriff \wort{Geruch},
...
Der Traum — das gelbe Kleid — der Buddha\ldots{}
...
ein altes Bild denken: \werk{Im Reisewagen}).
...
während ihrer \markup{Gottesdienste} nichts dergleichen erlebten. Doch sie
...
\markup{Schutzengel} schuf, die jedem Menschen von seiner Geburt an
zugesellt waren.
%
...
Geschmack des \markup{Likörs}) — und ein Schluck des brennenden Giftes floss
...
geschlafen. Keinerlei \markup{Träume} oder andere krankhafte Symptome.
...
Dieser an sich recht unbedeutende Vorfall hatte
...
dem Titel \werk{Glück}. Ich glaube, ich täusche mich nicht, wenn ich
...
Der Weg, den ich in Gedanken zurücklegte, führte mich
...
Nehmen wir zum Beispiel unsere berühmten \werk{Mathematischen Nonen} —
hätten wir ohne sie in der Schule die vier Grundrechnungsarten so
aufrichtig lieben gelernt? Oder die \werk{Dornen} — ein geradezu
...
Der Schelm, er läuft nach Hause\ldots{}“ usw. Und die täglichen Oden auf %Markup?
...
Und die roten \werk{Blüten der Gerichtsurteile}, die unsterbliche Tragödie
\werk{Zu spät zur Arbeit} gekommen und das Volksbuch \werk{Stanzen über
...
Unsere Götter sind hier auf Erden, sie stehen
...
Ich sah
ein Schild \markup{Gesundheitsamt} und begriff alles.
%
Ein gläsernes, von
...
„Was ist denn das für ein unzivilisierter Ausdruck — \wort{mein}? Ich war
...
\markup{Gesundheitsamt}\ldots{} Weshalb er mich hierher und nicht in den
...
befunden, den unsere Vorfahren \wort{Ohnmacht} nannten und der, soviel ich
...
die Türspalte und fiel wie eine scharfe, blitzende Schneide auf I.s %TODO
...
nicht, dass diese lächerliche \markup{Seele} ebenso wirklich war wie meine
...
Stiefel keine Krankheit waren, warum war dann die \markup{Seele} eine
Krankheit?
...
anderes als meine \markup{Seele}, die sich gleich dem Skorpion unserer
Vorfahren mit all dem stach, was\ldots{}

Der Wecker rasselte. Es war
...
Als ich nach Hause kam, war die Sonne
...
quälenden \markup{Seele} geheilt hat und dass ich nun wieder so bin wie wir
...
Vorurteile unserer Ahnen, an ihre \markup{Rechtsideen} waren.
...
Säuren war unseren Vorfahren bereits bekannt, die \markup{reductio ad
...
Spielzeug. Nehmen wir an, man würde die Idee \wort{Wahrheit} mit Säure
...
das \markup{Ich}, auf der anderen \markup{Wir}, der Einzige Staat. Dem \markup{Ich}
...
Geschichte erleuchtet, phantasierten: ihr \markup{Gott} — Schmach und
...
Natur aus zuwider ist; der \markup{homo sapiens} ist nur dann ein Mensch im
...
Ich antwortete nicht. Meine Arme waren mir im Wege.
...
„Im Grunde genommen ist es ja auch gleichgültig. Nur, dass man
...
eine Tugend, Stolz hingegen ein Laster ist, dass \wort{Wir} von Gott
stammt und \wort{Ich} vom Teufel.
...
Ähnliches wie das \markup{Osterfest} unserer Ahnen. Ich kann mich noch genau
...
Ich wurde unterbrochen, der Schneider brachte meine neue
...
besteht, dass wir — in den Worten des \werk{Evangeliums} gesagt — die
...
sein, denn \wort{alle} und \wort{ich} — das ist das große \wort{Wir}. Unsere
...
Mein Blick fällt auf die gläserne Wand
...
Aller Augen blickten zum Himmel auf; in dem
...
bisweilen ein \markup{Gewitter} über den ungezähmten Himmel jagte. Die Luft
...
Aber in dieser Vorstellung lag ja
...
\uebersicht{\emph{Übersicht:} Die Welt existiert. Aussatz. 41\textdegree{}.}
...
viertausend \ldots{} Menschen. Nun, nennen wir sie \wort{Menschen}, anders kann
...
Ich kann schon längst nicht mehr unterscheiden, wer \markup{sie} und wer \markup{wir}
...
Ich kann mich noch deutlich an jede ihrer
...
„Um des Wohltäters willen?“ Ein spöttisches Lächeln.
...
krankhaft \markup{Liebe}, \markup{Mitleid} und Ähnliches ist, das eine solche
...
Liebe Leser, wenn Sie dies in meinen
...
eine Kolonne von etwa fünfzig \wort{Menschen} herausgestampft. Menschen
...
Wir kamen zu dem Haus, in dem ich wohne. O
...
Sie erinnerten mich an die tragischen Gestalten der \markup{Freigelassenen},
...
% ldots sinnvoll?
\ldots{} Punkt 21 Uhr. U kam zu mir. Ich atmete so
...
Wenn ich eine Mutter hätte, wie
...
ist das die ganze Übersicht: Die weggeworfene Zigarette.)}
...
Der Himmel war blau, leer, bis auf
...
goldenen Aufschrift: \markup{Schutzamt}. Bevor ich eintrat, blieb ich eine
...
Man setzte sie unter die Gasglocke. Ihr
